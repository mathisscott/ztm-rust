...
// setting these types here allow us to change the database w/o affecting the app at large
pub type AppDatabase = Database<Sqlite>;
pub type DatabasePool = sqlx::sqlite::SqlitePool; // pool of connections that are constantly reused
pub type Transaction<'t> = sqlx::Transaction<'t, Sqlite>; // allows us to rollback if there are any issues
